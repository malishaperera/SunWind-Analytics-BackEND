...
async function seed() {
    try {
        ...
        const records = [];
        const startDate = new Date("2025-10-100T08:00:00Z"); // August 1, 2025 8pm UTC
        const endDate = new Date("2025-11-18T08:00:00Z"); // November 9, 2025 8am UTC
        ...
        console.log(
            `Database seeded successfully. Generated ${recordCount} energy generation records from August 1, 2025 8pm to October 12, 2025 8am.`
        );
    } catch (err) {
